...
namespace Counter.Resources.Utils
{
	/// <summary>
		...
		private IntPtr LowLevelKeyboardProc(int nCode, UIntPtr wParam, IntPtr lParam)
		{
			...
			if (nCode >= 0)
					...
					wParam.ToUInt32() == (int)InterceptKeys.KeyEvent.WM_SYSKEYUP)
				{
					...
					//Is not supported on .NET Core platform
					//hookedKeyboardCallbackAsync.BeginInvoke((InterceptKeys.KeyEvent)wParam.ToUInt32(), Marshal.ReadInt32(lParam), chars, null, null);
					//Equivalent for .NET Core
					Task.Run(() => hookedKeyboardCallbackAsync.Invoke((InterceptKeys.KeyEvent)wParam.ToUInt32(), Marshal.ReadInt32(lParam), chars));
				}
